...
<div class="grid_3">
  <div class="container">
   ...
   <div class="terms_1">
	    <h3>The standard chunk of connections used since the 1500s is reproduced</h3>	
	    <ul class="feature_list">
			<li><a href="#">1. There are many variations of passages available.</a></li>
	    ...
	    <ul class="feature_list feature_list1">
			<li><a href="#">There are many variations of passages available.</a></li>
